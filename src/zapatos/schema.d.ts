...
declare module 'zapatos/schema' {
  ...
  export namespace users {
    ...
    export interface Whereable {
      ...
      * - Nullable, no default
      */
      discord_id?: string | db.Parameter<string> | db.SQLFragment | db.ParentColumn | db.SQLFragment<any, string | db.Parameter<string> | db.SQLFragment | db.ParentColumn>;
      /**
      * **users.osu_id**
      * - `text` in database
      * - Nullable, no default
      */
      osu_id?: string | db.Parameter<string> | db.SQLFragment | db.ParentColumn | db.SQLFragment<any, string | db.Parameter<string> | db.SQLFragment | db.ParentColumn>;
    }
    export interface Insertable {
      /**
      * **users.id**
      ...
      * - Nullable, no default
      */
      discord_id?: string | db.Parameter<string> | null | db.DefaultType | db.SQLFragment;
      /**
      * **users.osu_id**
      * - `text` in database
      * - Nullable, no default
      */
      osu_id?: string | db.Parameter<string> | null | db.DefaultType | db.SQLFragment;
    }
    export interface Updatable {
      /**
      * **users.id**
      ...
      * - Nullable, no default
      */
      discord_id?: string | db.Parameter<string> | null | db.DefaultType | db.SQLFragment | db.SQLFragment<any, string | db.Parameter<string> | null | db.DefaultType | db.SQLFragment>;
      /**
      * **users.osu_id**
      * - `text` in database
      * - Nullable, no default
      */
      osu_id?: string | db.Parameter<string> | null | db.DefaultType | db.SQLFragment | db.SQLFragment<any, string | db.Parameter<string> | null | db.DefaultType | db.SQLFragment>;
    }
